...
\schemestart
\chemname
  {\chemfig[baseline]{*6(-=*5(-\chembelow{N}{H}-=-)-=-=)}}
  {\shortstack{\ce{C8H7N}\\Indol}}
\+
\chemname
  {\chemfig[baseline]{H-[:+30,0.8](=[2,0.7]O)-[:-30,0.7]H}}
  {\shortstack{\ce{CH2O}\\Formaldehyd}}
\+
\chemname
  {\chemfig[baseline]{H_3C-[:+30,0.8]N(-[2,0.7]H)-[:-30,0.7]CH_3}}
  {\shortstack{\ce{C2H7N}\\Dimethylamin}}
\arrow{->[\chemfig{AcOH}][-\chemfig{H_2O}]}
\chemname
  {\chemfig[baseline]{*6(-=*5(-\chembelow{N}{H}-=(-[:72,0.7](-[:18,0.8]N(-[:42,0.7]CH_3)(-[:-42,0.7]CH_3)))-)-=-=)}}
  {\shortstack{\ce{C11H14N2}\\\iupac{3-(Dimethylaminomethyl)indol}}}
\schemestop
\end{center}
